...
<html lang="en">
    ...
    <body>
        ...
        <?php
            if (!empty($_GET["action"]) && $_GET["action"] == 'delete-agenda' && !empty($_GET["agenda"]) && is_numeric($_GET["agenda"])) {
        ?>
            <script type="text/javascript">
                $(window).on('load', function() {
                    $('#alertModal').modal('show');
            ...
            <div class="modal fade" id="alertModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Are you sure you want to delete?</div>
                            <div class="modal-footer">
                                <a class="btn btn-primary" href="/delete-agenda/<?php if (!empty($_GET["agenda"]) && is_numeric($_GET["agenda"])) { echo $_GET["agenda"]; } ?>">Yes</a>
                                <a class="btn btn-secondary" href="/agenda">No</a>
                                <!-- <button class="btn btn-secondary" type="button" data-bs-dismiss="modal">No</button> -->
                            </div>
                        </div>
                    </div>
